...
with st.sidebar.expander("1. Agent 1 (Red) Parameters", expanded=True):
    ...
    mcts_sims1 = st.slider("MCTS Simulations₁", 50, 500, 50, 25)
    minimax_depth1 = st.slider("Minimax Depth₁", 3, 7, 3, 1)
...
with st.sidebar.expander("2. Agent 2 (White) Parameters", expanded=True):
    ...
    mcts_sims2 = st.slider("MCTS Simulations₂", 50, 500, 50, 25)
    minimax_depth2 = st.slider("Minimax Depth₂", 3, 7, 3, 1)
